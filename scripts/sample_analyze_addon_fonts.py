# Sourced from: https://github.com/Azure/azure-sdk-for-python/blob/main/sdk/documentintelligence/azure-ai-documentintelligence/samples/sample_analyze_addon_fonts.py
# Helpful to see cases where a PDF contains both code and text, and there's a need to split the two based upon
# font families, or some other derived logic
# coding: utf-8
